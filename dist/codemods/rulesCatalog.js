...
import { replaceMatchedPrefix, replacePattern, replaceSendTransactionCallee, transformSource, } from "./ast-helpers.js";
...
const CORE_RULES = [
    ...
    },
    {
        ...
        docsUrl: DOCS,
        apply: (source, fp) => transformSource(source, "ethers.providers.getNetwork($$$ARGS)", (m) => replaceMatchedPrefix(m, "ethers.providers.getNetwork", "ethers.getNetwork"), fp).code,
    },
    {
    ...
    },
    {
        ...
        docsUrl: DOCS,
        apply: (source, fp) => transformSource(source, "ethers.utils.formatBytes32String($$$A)", (m) => replaceMatchedPrefix(m, "ethers.utils.formatBytes32String", "ethers.encodeBytes32String"), fp).code,
    },
    {
        ...
        docsUrl: DOCS,
        apply: (source, fp) => transformSource(source, "ethers.utils.parseBytes32String($$$A)", (m) => replaceMatchedPrefix(m, "ethers.utils.parseBytes32String", "ethers.decodeBytes32String"), fp).code,
    },
    {
        ...
        docsUrl: DOCS,
        apply: (source, fp) => transformSource(source, "ethers.utils.hexDataSlice($$$A)", (m) => replaceMatchedPrefix(m, "ethers.utils.hexDataSlice", "ethers.dataSlice"), fp).code,
    },
    {
        ...
        docsUrl: DOCS,
        apply: (source, fp) => transformSource(source, "ethers.utils.hexZeroPad($$$A)", (m) => replaceMatchedPrefix(m, "ethers.utils.hexZeroPad", "ethers.zeroPadValue"), fp).code,
    },
    {
        id: "utils:hex-value",
        ...
        docsUrl: DOCS,
        apply: (source, fp) => transformSource(source, "ethers.utils.hexValue($$$A)", (m) => replaceMatchedPrefix(m, "ethers.utils.hexValue", "ethers.toQuantity"), fp).code,
    },
    {
        id: "utils:arrayify",
        ...
        now: "ethers.getBytes(",
        docsUrl: DOCS,
        apply: (source, fp) => transformSource(source, "ethers.utils.arrayify($$$A)", (m) => replaceMatchedPrefix(m, "ethers.utils.arrayify", "ethers.getBytes"), fp).code,
    },
];
